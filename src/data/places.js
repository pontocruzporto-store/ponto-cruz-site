...
export default [
  // EXAMPLE PLACE - Remove or modify for actual recommendations
  {
    ...
    image: "/images/places/francesinha_café-1200.webp",
    category: "eat",
    featured: true,
    location: {
      lat: 41.16037,
    ...
    translations: {
      pt: {
        ...
        description:
          "De forma praticamente unânime entre os portuenses, serve uma das melhores francesinhas do Porto — e, para muitos, do mundo. Molho intenso, ingredientes de qualidade e execução irrepreensível tornam este espaço uma paragem obrigatória.",
      ...
      ko: {
        name: "Francesinha Café",
        description:
          "현지인들 사이에서 포르투 최고의 프란세지냐 맛집 중 하나로 unanimously 인정받는 곳이며, 세계 최고 수준으로도 평가됩니다. 진한 소스와 뛰어난 재료, 완벽한 조리가 특징입니다.",
        tips: "대기 시간이 매우 길 수 있으므로 아주 일찍 도착하세요. 예약이 가능하지만 항상 성공하는 것은 아닙니다.",
      },
      ja: {
        name: "Francesinha Café",
        description:
          "地元の人々の間でポルト最高のフランセジーニャの一つとしてほぼ満場一致で認められており、世界でもトップクラスと評されます。濃厚なソースと高品質な食材、完璧な仕上がりが魅力です。",
  ...
  {
    slug: "mirandas-kaffe",
    image: "/images/places/mirandas_kaffe-1200.webp",
    category: "eat",
    featured: true,
    location: {
      lat: 41.16301,
    ...
    translations: {
      pt: {
        name: "Mirandas Kaffe",
        description:
          "Uma tasca moderna com ambiente descontraído e muito portuense, famosa pela sua francesinha intensa e pelo prego em pão extremamente suculento. Com televisão a passar futebol e um espírito de convívio constante, é um clássico para comer bem e sem formalidades.",
      ...
      ko: {
        name: "Mirandas Kaffe",
        description:
          "현지 분위기가 가득한 캐주얼 타베르나 스타일의 맛집으로, 진한 프란세지냐와 육즙 가득한 프레구 샌드위치로 유명합니다. 축구 중계와 활기찬 분위기가 어우러진 정통 포르투 식당입니다.",
        tips: "현금만 받는 경우가 많으니 미리 준비하세요. 피크 시간에는 대기할 수 있습니다.",
      },
      ja: {
        name: "Mirandas Kaffe",
        description:
          "地元らしいリラックスした雰囲気のタベルナ風レストランで、濃厚なフランセジーニャとジューシーなステーキサンドが名物です。テレビでサッカーが流れる活気ある空間で、本場の食事が楽しめます。",
  ...
  },
  {
    ...
    image: "/images/places/palacio_da_bolsa-1200.webp",
    category: "visit",
    featured: true,
    location: {
      lat: 41.14157,
    ...
    translations: {
      pt: {
        ...
        description:
          "Um dos edifícios históricos mais emblemáticos do Porto, conhecido pelos seus salões luxuosos e pelo impressionante Salão Árabe. Antiga sede da Associação Comercial do Porto, combina arquitetura neoclássica com interiores ricamente decorados e é uma visita essencial para compreender a história comercial da cidade.",
      ...
      ko: {
        name: "볼사 궁전",
        description:
          "화려한 살롱과 압도적인 아라비안 홀로 유명한 포르투의 대표적인 역사 건축물입니다. 과거 상공회의소 건물로 사용되었으며, 신고전주의 건축과 화려한 내부 장식이 도시의 상업 역사를 잘 보여줍니다.",
      ...
      ja: {
        name: "ボルサ宮殿",
        description:
          "豪華な装飾の広間と圧巻のアラブの間で知られる、ポルトを代表する歴史的建造物です。かつての商工会議所で、新古典主義建築と華麗な内装が街の商業の歴史を物語ります。",
